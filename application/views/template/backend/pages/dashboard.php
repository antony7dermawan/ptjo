      ...
      <table>
        <tr>
          ...
          <th>
            ...
            <input type='date' name='date_from_dashboard' value='<?php echo $this->session->userdata('date_from_dashboard');?>' >
          </th>
          <th>-</th>
          <th>
            <form action='/action_page.php' >
            <input type='date' name='date_to_dashboard' value='<?php echo $this->session->userdata('date_to_dashboard');?>' >
          </th>
          <th>

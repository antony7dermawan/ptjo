            ...
            <th>
              <input type='button' name='' class='btn btn-primary waves-effect waves-light' onclick='receive_from_cloud()' value='Receive From Cloud'>
                ...
                function receive_from_cloud()
                {
                  ...
                  {
                    window.open('receive_cloud/receive_t_m_a_supir');
                  }
        ...
        <div class="modal-body">
          <div class="">
            ...
            <div class="form-group">
              <label>Supir ID</label>
              <input type='text' class='form-control' placeholder='Harus Angka' name='supir_id'>
            </div>
...
<script>
  ...
  [...elBtnEdits].forEach(edit => {
    edit.addEventListener("click", (e) => {
      ...
      elModalEdit.querySelector("[name=supir_id]").value = supir_id;

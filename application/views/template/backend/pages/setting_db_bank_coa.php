      ...
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          ...
          foreach ($c_setting_db_bank_coa as $key => $value) 
          {
            ...
            echo "<a href='".site_url('c_setting_db_bank_coa/delete/' . $value->ID)."' ";
            ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_setting_db_bank_coa/tambah') ?>" method="post">

      ...
      <table>
        <tr>
          <th>
            ...
            <input type='date' name='date_from_select_jurnal' value='<?php echo $this->session->userdata('date_from_select_jurnal');?>'  >
          </th>
          <th>-</th>
          <th>
            <form action='/action_page.php' >
            <input type='date' name='date_to_select_jurnal' value='<?php echo $this->session->userdata('date_to_select_jurnal');?>'  >
          </th>
          <th>

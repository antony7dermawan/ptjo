      ...
      <table>
        <tr>
          ...
          <th>
            ...
            <input type='date' name='date_terima_pelanggan' value='<?= $this->session->userdata('date_terima_pelanggan')?>' onchange='this.form.submit();'>
          </th>
        </tr>
      </table>
      ...
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          ...
          foreach ($c_t_ak_terima_pelanggan as $key => $value) 
          {
            ...
            echo "<a href='".site_url('c_t_ak_terima_pelanggan/update_enable_edit/'.$value->ID)."/".$value->SUM_TOTAL_PENJUALAN."/".$value->SUM_JUMLAH."/".$value->SUM_DISKON."/".$value->ENABLE_EDIT."'"; #/1 ini artinya kena pajak
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form action='/action_page.php' >
          <input type='date' name='date' value='<?= $this->session->userdata('date_terima_pelanggan')?>'>
          </h4>

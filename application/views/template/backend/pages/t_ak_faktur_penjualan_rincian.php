      ...
      <table>
        <tr>
          ...
          <th>
            ...
            <input type='date' name='date_from_select_penjualan' value='<?php echo $this->session->userdata('date_from_select_penjualan');?>' <?=$disabled?> >
          </th>
          <th>-</th>
          <th>
            <form action='/action_page.php' >
            <input type='date' name='date_to_select_penjualan' value='<?php echo $this->session->userdata('date_to_select_penjualan');?>' <?=$disabled?> >
          </th>
          <th>

  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_ak_terima_pelanggan_metode_bayar as $key => $value) 
          {
                if($value->NO_AKUN_3!='')
                {
            ...
            if($disabled == '')
            {
              echo "<a href='".site_url('c_t_ak_terima_pelanggan_metode_bayar/delete/'.$value->ID.'/'.$terima_pelanggan_id.'/'.$pks_id)."' ";
...
<form action="<?php echo base_url("c_t_ak_terima_pelanggan_metode_bayar/tambah/".$terima_pelanggan_id."/".$pks_id) ?>" method="post">

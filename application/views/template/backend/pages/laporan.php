      ...
      <table>
        <tr>
          ...
          <th>
            ...
            <input type='date' id='date_from_laporan' value='<?php echo $this->session->userdata('date_from_select_jurnal');?>'  >
          </th>
          <th>-</th>
          <th>
            <form action='/action_page.php' >
            <input type='date' id='date_to_laporan' value='<?php echo $this->session->userdata('date_to_select_jurnal');?>'  >
          </th>
          <th>

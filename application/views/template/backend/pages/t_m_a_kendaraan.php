            ...
            <th>
              <input type='button' name='' class='btn btn-primary waves-effect waves-light' onclick='receive_from_cloud()' value='Receive From Cloud'>
                ...
                function receive_from_cloud()
                {
                  ...
                  {
                    window.open('receive_cloud/receive_t_m_a_kendaraan');
                  }
      ...
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          ...
          foreach ($c_t_m_a_kendaraan as $key => $value) 
          {
            ...
            echo "<a href='".site_url('c_t_m_a_kendaraan/delete/' . $value->ID)."' ";
            ?>
...
<!-- MODAL TAMBAH Beban! !-->
<form action="<?php echo base_url('c_t_m_a_kendaraan/tambah') ?>" method="post">
        ...
        <div class="modal-body">
          <div class="">
            ...
            <div class="form-group">
              ...
              <input type='text' class='form-control' placeholder='Harus Angka' name='kendaraan_id'>
            </div>

            <div class="form-group">
              <label>Kendaraan</label>
              <input type='text' class='form-control' placeholder='Input Text' name='kendaraan'>
            </div>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_m_a_kendaraan/edit_action') ?>" method="post">
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const users = <?= json_encode($c_t_m_a_kendaraan) ?>;
  console.log(users);
  ...
  [...elBtnEdits].forEach(edit => {
    edit.addEventListener("click", (e) => {
      ...
      elModalEdit.querySelector("[name=kendaraan_id]").value = kendaraan_id;

  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_ak_pembayaran_supplier_diskon as $key => $value) 
          {
                if($value->NO_AKUN_3!='')
                {
            ...
            if($disabled == '')
            {
              echo "<a href='".site_url('c_t_ak_pembayaran_supplier_diskon/delete/'.$value->ID.'/'.$pembayaran_supplier_id.'/'.$supplier_id)."' ";
...
<form action="<?php echo base_url("c_t_ak_pembayaran_supplier_diskon/tambah/".$pembayaran_supplier_id."/".$supplier_id) ?>" method="post">
